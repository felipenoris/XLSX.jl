...
setFont(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, ::Colon; kw...) = process_veccolon(setFont, ws, row, :; kw...)
setFont(ws::Worksheet, ::Colon, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_colonvec(setFont, ws, :, col; kw...)
setFont(ws::Worksheet, ::Colon, ::Colon; kw...) = process_colon(setFont, ws, :; kw...)
setFont(ws::Worksheet, ::Colon; kw...) = process_colon(setFont, ws, :; kw...)
setFont(ws::Worksheet, row::Union{Integer,UnitRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_intvec(setFont, ws, row, col; kw...)
...
setFont(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_vecvec(setFont, ws, row, col; kw...)
...
setUniformFont(ws::Worksheet, row::Union{Integer,UnitRange{<:Integer}}, ::Colon; kw...) = process_uniform_intcolon(setFont, ws, row, :; kw...)
setUniformFont(ws::Worksheet, ::Colon, col::Union{Integer,UnitRange{<:Integer}}; kw...) = process_uniform_colonint(setFont, ws, :, col; kw...)
setUniformFont(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, ::Colon; kw...) = process_uniform_veccolon(setFont, ws, row, :, ["fontId", "applyFont"]; kw...)
setUniformFont(ws::Worksheet, ::Colon, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_uniform_colonvec(setFont, ws, :, col, ["fontId", "applyFont"]; kw...)
setUniformFont(ws::Worksheet, ::Colon, ::Colon; kw...) = process_uniform_colon(setUniformFont, ws, :; kw...)
setUniformFont(ws::Worksheet, ::Colon; kw...) = process_uniform_colon(setUniformFont, ws, :; kw...)
setUniformFont(ws::Worksheet, row::Union{Integer,UnitRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_uniform_intvec(setFont, ws, row, col, ["fontId", "applyFont"]; kw...)
...
setUniformFont(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_uniform_vecvec(setFont, ws, row, col, ["fontId", "applyFont"]; kw...)
...
setBorder(ws::Worksheet, ::Colon, ::Colon; kw...) = process_colon(setBorder, ws, :; kw...)
setBorder(ws::Worksheet, ::Colon; kw...) = process_colon(setBorder, ws, :; kw...)
setBorder(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, ::Colon; kw...) = process_veccolon(setBorder, ws, row, :; kw...)
setBorder(ws::Worksheet, ::Colon, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_colonvec(setBorder, ws, :, col; kw...)
setBorder(ws::Worksheet, row::Union{Integer,UnitRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_intvec(setBorder, ws, row, col; kw...)
...
setBorder(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_vecvec(setBorder, ws, row, col; kw...)
...
setUniformBorder(ws::Worksheet, row::Union{Integer,UnitRange{<:Integer}}, ::Colon; kw...) = process_uniform_intcolon(setBorder, ws, row, :; kw...)
setUniformBorder(ws::Worksheet, ::Colon, col::Union{Integer,UnitRange{<:Integer}}; kw...) = process_uniform_colonint(setBorder, ws, :, col; kw...)
setUniformBorder(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, ::Colon; kw...) = process_uniform_veccolon(setBorder, ws, row, :, ["borderId", "applyBorder"]; kw...)
setUniformBorder(ws::Worksheet, ::Colon, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_uniform_colonvec(setBorder, ws, :, col, ["borderId", "applyBorder"]; kw...)
setUniformBorder(ws::Worksheet, ::Colon, ::Colon; kw...) = process_uniform_colon(setUniformBorder, ws, :; kw...)
setUniformBorder(ws::Worksheet, ::Colon; kw...) = process_uniform_colon(setUniformBorder, ws, :; kw...)
setUniformBorder(ws::Worksheet, row::Union{Integer,UnitRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_uniform_intvec(setBorder, ws, row, col, ["borderId", "applyBorder"]; kw...)
...
setUniformBorder(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_uniform_vecvec(setBorder, ws, row, col, ["borderId", "applyBorder"]; kw...)
...
setOutsideBorder(ws::Worksheet, ::Colon, ::Colon; kw...) = process_uniform_colon(setOutsideBorder, ws, :; kw...)
setOutsideBorder(ws::Worksheet, ::Colon; kw...) = process_uniform_colon(setOutsideBorder, ws, :; kw...)
...
setFill(ws::Worksheet, ::Colon, ::Colon; kw...) = process_colon(setFill, ws, :; kw...)
setFill(ws::Worksheet, ::Colon; kw...) = process_colon(setFill, ws, :; kw...)
setFill(ws::Worksheet, ::Colon, col::Union{Integer,UnitRange{<:Integer}}; kw...) = process_colonint(setFill, ws, :, col; kw...)
setFill(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, ::Colon; kw...) = process_veccolon(setFill, ws, row, :; kw...)
setFill(ws::Worksheet, ::Colon, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_colonvec(setFill, ws, :, col; kw...)
setFill(ws::Worksheet, row::Union{Integer,UnitRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_intvec(setFill, ws, row, col; kw...)
...
setFill(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_vecvec(setFill, ws, row, col; kw...)
...
setUniformFill(ws::Worksheet, row::Union{Integer,UnitRange{<:Integer}}, ::Colon; kw...) = process_uniform_intcolon(setFill, ws, row, :; kw...)
setUniformFill(ws::Worksheet, ::Colon, col::Union{Integer,UnitRange{<:Integer}}; kw...) = process_uniform_colonint(setFill, ws, :, col; kw...)
setUniformFill(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, ::Colon; kw...) = process_uniform_veccolon(setFill, ws, row, :, ["fillId", "applyFill"]; kw...)
setUniformFill(ws::Worksheet, ::Colon, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_uniform_colonvec(setFill, ws, :, col, ["fillId", "applyFill"]; kw...)
setUniformFill(ws::Worksheet, ::Colon, ::Colon; kw...) = process_uniform_colon(setUniformFill, ws, :; kw...)
setUniformFill(ws::Worksheet, ::Colon; kw...) = process_uniform_colon(setUniformFill, ws, :; kw...)
setUniformFill(ws::Worksheet, row::Union{Integer,UnitRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_uniform_intvec(setFill, ws, row, col, ["fillId", "applyFill"]; kw...)
...
setUniformFill(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_uniform_vecvec(setFill, ws, row, col, ["fillId", "applyFill"]; kw...)
...
setAlignment(ws::Worksheet, ::Colon, ::Colon; kw...) = process_colon(setAlignment, ws, :; kw...)
setAlignment(ws::Worksheet, ::Colon; kw...) = process_colon(setAlignment, ws, :; kw...)
setAlignment(ws::Worksheet, ::Colon, col::Union{Integer,UnitRange{<:Integer}}; kw...) = process_colonint(setAlignment, ws, :, col; kw...)
setAlignment(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, ::Colon; kw...) = process_veccolon(setAlignment, ws, row, :; kw...)
setAlignment(ws::Worksheet, ::Colon, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_colonvec(setAlignment, ws, :, col; kw...)
setAlignment(ws::Worksheet, row::Union{Integer,UnitRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_intvec(setAlignment, ws, row, col; kw...)
...
setAlignment(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_vecvec(setAlignment, ws, row, col; kw...)
...
setUniformAlignment(ws::Worksheet, row::Union{Integer,UnitRange{<:Integer}}, ::Colon; kw...) = process_uniform_intcolon(setAlignment, ws, row, :; kw...)
setUniformAlignment(ws::Worksheet, ::Colon, col::Union{Integer,UnitRange{<:Integer}}; kw...) = process_uniform_colonint(setAlignment, ws, :, col; kw...)
setUniformAlignment(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, ::Colon; kw...) = process_uniform_veccolon(setAlignment, ws, row, :; kw...)
setUniformAlignment(ws::Worksheet, ::Colon, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_uniform_colonvec(setAlignment, ws, :, col; kw...)
setUniformAlignment(ws::Worksheet, ::Colon, ::Colon; kw...) = process_uniform_colon(setUniformAlignment, ws, :; kw...)
setUniformAlignment(ws::Worksheet, ::Colon; kw...) = process_uniform_colon(setUniformAlignment, ws, :; kw...)
setUniformAlignment(ws::Worksheet, row::Union{Integer,UnitRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_uniform_intvec(setAlignment, ws, row, col; kw...)
...
setUniformAlignment(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_uniform_vecvec(setAlignment, ws, row, col; kw...)
...
setFormat(ws::Worksheet, ::Colon, ::Colon; kw...) = process_colon(setFormat, ws, :; kw...)
setFormat(ws::Worksheet, ::Colon; kw...) = process_colon(setFormat, ws, :; kw...)
setFormat(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, ::Colon; kw...) = process_veccolon(setFormat, ws, row, :; kw...)
setFormat(ws::Worksheet, ::Colon, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_colonvec(setFormat, ws, :, col; kw...)
setFormat(ws::Worksheet, row::Union{Integer,UnitRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_intvec(setFormat, ws, row, col; kw...)
...
setFormat(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_vecvec(setFormat, ws, row, col; kw...)
...
setUniformFormat(ws::Worksheet, row::Union{Integer,UnitRange{<:Integer}}, ::Colon; kw...) = process_uniform_intcolon(setFormat, ws, row, :; kw...)
setUniformFormat(ws::Worksheet, ::Colon, col::Union{Integer,UnitRange{<:Integer}}; kw...) = process_uniform_colonint(setFormat, ws, :, col; kw...)
setUniformFormat(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, ::Colon; kw...) = process_uniform_veccolon(setFormat, ws, row, :, ["numFmtId", "applyNumberFormat"]; kw...)
setUniformFormat(ws::Worksheet, ::Colon, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_uniform_colonvec(setFormat, ws, :, col, ["numFmtId", "applyNumberFormat"]; kw...)
setUniformFormat(ws::Worksheet, ::Colon, ::Colon; kw...) = process_uniform_colon(setUniformFormat, ws, :; kw...)
setUniformFormat(ws::Worksheet, ::Colon; kw...) = process_uniform_colon(setUniformFormat, ws, :; kw...)
setUniformFormat(ws::Worksheet, row::Union{Integer,UnitRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_uniform_intvec(setFormat, ws, row, col, ["numFmtId", "applyNumberFormat"]; kw...)
...
setUniformFormat(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_uniform_vecvec(setFormat, ws, row, col, ["numFmtId", "applyNumberFormat"]; kw...)
...
setUniformStyle(ws::Worksheet, row::Union{Integer,UnitRange{<:Integer}}, ::Colon) = process_uniform_intcolon(ws, row, :)
setUniformStyle(ws::Worksheet, ::Colon, col::Union{Integer,UnitRange{<:Integer}}) = process_uniform_colonint(ws, :, col)
setUniformStyle(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, ::Colon) = process_uniform_veccolon(ws, row, :)
setUniformStyle(ws::Worksheet, ::Colon, col::Union{Vector{Int},StepRange{<:Integer}}) = process_uniform_colonvec(ws, :, col)
setUniformStyle(ws::Worksheet, ::Colon, ::Colon) = process_uniform_colon(ws, :)
setUniformStyle(ws::Worksheet, ::Colon) = process_uniform_colon(ws, :)
setUniformStyle(ws::Worksheet, row::Union{Integer,UnitRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}) = process_uniform_intvec(ws, row, col)
...
setUniformStyle(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}) = process_uniform_vecvec(ws, row, col)
...
setColumnWidth(ws::Worksheet, col::Union{Integer,UnitRange{<:Integer}}; kw...) = process_colonint(setColumnWidth, ws, :, col; kw...)
setColumnWidth(ws::Worksheet, ::Colon, col::Union{Integer,UnitRange{<:Integer}}; kw...) = process_colonint(setColumnWidth, ws, :, col; kw...)
setColumnWidth(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, ::Colon; kw...) = process_veccolon(setColumnWidth, ws, row, :; kw...)
setColumnWidth(ws::Worksheet, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_colonvec(setColumnWidth, ws, :, col; kw...)
setColumnWidth(ws::Worksheet, ::Colon, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_colonvec(setColumnWidth, ws, :, col; kw...)
setColumnWidth(ws::Worksheet, ::Colon, ::Colon; kw...) = process_colon(setColumnWidth, ws, :; kw...)
setColumnWidth(ws::Worksheet, ::Colon; kw...) = process_colon(setColumnWidth, ws, :; kw...)
setColumnWidth(ws::Worksheet, row::Union{Integer,UnitRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_intvec(setColumnWidth, ws, row, col; kw...)
...
setColumnWidth(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_vecvec(setColumnWidth, ws, row, col; kw...)
...
setRowHeight(ws::Worksheet, row::Union{Integer,UnitRange{<:Integer}}; kw...) = process_intcolon(setRowHeight, ws, row, :; kw...)
...
setRowHeight(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_veccolon(setRowHeight, ws, row, :; kw...)
setRowHeight(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, ::Colon; kw...) = process_veccolon(setRowHeight, ws, row, :; kw...)
setRowHeight(ws::Worksheet, ::Colon, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_colonvec(setRowHeight, ws, :, col; kw...)
setRowHeight(ws::Worksheet, ::Colon, ::Colon; kw...) = process_colon(setRowHeight, ws, :; kw...)
setRowHeight(ws::Worksheet, ::Colon; kw...) = process_colon(setRowHeight, ws, :; kw...)
setRowHeight(ws::Worksheet, row::Union{Integer,UnitRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_intvec(setRowHeight, ws, row, col; kw...)
...
setRowHeight(ws::Worksheet, row::Union{Vector{Int},StepRange{<:Integer}}, col::Union{Vector{Int},StepRange{<:Integer}}; kw...) = process_vecvec(setRowHeight, ws, row, col; kw...)
...
mergeCells(ws::Worksheet, row::Union{Integer,UnitRange{<:Integer}}, ::Colon) = process_intcolon(mergeCells, ws, row, :)
mergeCells(ws::Worksheet, ::Colon, col::Union{Integer,UnitRange{<:Integer}}) = process_colonint(mergeCells, ws, :, col)
mergeCells(ws::Worksheet, ::Colon, ::Colon) = process_colon(mergeCells, ws, :)
mergeCells(ws::Worksheet, ::Colon) = process_colon(mergeCells, ws, :)
