...
function writetable(filename::AbstractString, tables::Vector{Tuple{S, T1, T2}}; overwrite::Bool=false) where {S<:AbstractString, T1<:AbstractVector, T2<:AbstractVector}
